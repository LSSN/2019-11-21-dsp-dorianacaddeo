...
##### 1. Cos'è Faust? [1/10]
```
è un linguaggio di programmazione ,testuale (si scrive un testo che viene interpretato)funzionle (ha un solo scopo),ovvero si usa per scrivere programmi audio.
```
